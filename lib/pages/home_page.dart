import 'package:aiassistant/model/radio.dart';
import 'package:aiassistant/util/ai_util.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  setupAlan(){
    AlanVoice.addButton(
        "463ea134ca3ae9daf24e04e39b40f08f2e956eca572e1d8b807a3e2338fdd0dc/stage",
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          [
          AppBar(
            title: "GMusic".text.xl4.bold.white.make().shimmer(
            ...
            "Try talking Hey Alan".text.italic.semiBold.white.make(),
            10.heightBox,
            VxSwiper.builder(
              height: 50.0,
          ...
          Align(
            ...
            child: [
              if(_isPlaying)
                ...
                " \t\t\t\t\t\t\t\t\t\t\t\t\t Playing Now - ${_selectedRadio.name} FM \n To play next song , stop this and play \n \t\t\t\t\t\t\t\t\t\t\t\t\t Double tap to Stop ".text.white. makeCentered(),
...
class _HomePageState extends State<HomePage> {
  ...
  setupAlan() {
    AlanVoice.addButton("463ea134ca3ae9daf24e04e39b40f08f2e956eca572e1d8b807a3e2338fdd0dc/stage",
        buttonAlign: AlanVoice.BUTTON_ALIGN_LEFT);
    AlanVoice.callbacks.add((command) => _handleCommand(command.data));
  }
      ...
      body: Stack(
        children: [
          ...
          [
            ...
            "Try calling Hey Alan ".text.italic.semiBold.white.make(),
            10.heightBox,
            /* For suggestions
            VxSwiper.builder(
              itemCount: sugg.length,
